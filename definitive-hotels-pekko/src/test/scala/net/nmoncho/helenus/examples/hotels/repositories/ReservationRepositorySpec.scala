...
class ReservationRepositorySpec
    ...
    "ReservationRepository" should {
        "find a reservation by confirmation number" in {
            ...
            whenReady(repository.findReservationByConfirmation(Reservations.abc123.confirmationNumber))(reservation =>
                reservation shouldBe Some(Reservations.abc123)
            )
        ...
        "find a reservation by hotel id and date" in {
            ...
            whenReady(queryStream)(reservations => reservations.toSet shouldBe Set(Reservations.abc123))

            val queryStream2 = repository
                  .findReservationByHotelAndDate(
            ...
            whenReady(queryStream2)(reservations => reservations.toSet shouldBe Set(Reservations.mno345, Reservations.rsp214))
        }
        ...
        "find a reservation by guest name" in {
            ...
            whenReady(queryStream) { reservations =>
