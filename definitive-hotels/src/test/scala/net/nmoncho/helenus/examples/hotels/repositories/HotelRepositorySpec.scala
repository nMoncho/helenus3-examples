...
class HotelRepositorySpec extends AnyWordSpec with Matchers with BeforeAndAfterAll with CassandraSpec:
    ...
    "HotelRepository" should {
        ...
        "query room amenities" in {
            ...
            val amenities = repository.roomAmenities(HotelsTestData.Hotels.h1.id, 1.toShort)
