...
class ReservationRepository()(using CqlSession, ExecutionContext):
    ...
    def findReservationByGuestName(lastName: String): Future[Set[Reservation]] =
        for
...
object ReservationRepository:
    ...
    class Queries()(using CqlSession, ExecutionContext):
        import net.nmoncho.helenus.*
